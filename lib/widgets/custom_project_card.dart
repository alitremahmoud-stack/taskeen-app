...
class CustomProjectCard extends StatelessWidget {
  ...
  final bool showActions; // ✅ إظهار أزرار التعديل والحذف
  ...
  const CustomProjectCard({
    ...
    this.onEdit,
    this.onDelete,
    this.showActions = true, // افتراضياً تظهر الأزرار
  });
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ عرض الأزرار فقط إذا كانت showActions == true
              if (showActions) ...[
                const SizedBox(height: 12),
                Row(
